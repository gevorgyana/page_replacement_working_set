...
public class PageAllocator {
    private WorkingSetMaintainer workingSetMaintainer; // we need this to tell us whom to evict, BUT we do not modify
    ...
    /**attention - there can't be 2 or more same elements as this is the set, not multiset,
